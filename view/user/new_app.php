                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group"> 
                                              ...
                                              <input id="form_name" type="text"  class="form-control"  required="required" data-error="Firstname is required." placeholder="id_banner" name="id_banner" > </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group"> 
                                              <label for="form_lastname">Interstitial Ad Id *</label> 
                                              <input id="form_lastname" type="text"  class="form-control"  required="required" data-error="Lastname is required." placeholder="id_inter" name="id_inter" > </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group"> 
                                              ...
                                              <input id="form_name" type="text"  class="form-control"  required="required" data-error="Firstname is required." placeholder="reawrd id" name="id_reward" > </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group"> 
                                              <label for="form_lastname">Package name *</label> 
                                              <input id="form_lastname" type="text"  class="form-control"  required="required" data-error="Lastname is required." placeholder="package name" name="package_name" > </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group"> <label for="form_need">Please specify App state *</label> 
                                            <select id="form_need"  class="form-control" required="required" data-error="Please specify your app state." name="state" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group"> 
                                                ...
                                                <textarea id="form_message"  class="form-control" placeholder="Short Description about your app"  rows="4" required="required" data-error="Please, descripe your app." name="short_description" ></textarea> </div>
                                        </div>
